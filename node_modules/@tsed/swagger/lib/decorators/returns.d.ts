 ...
 * @swagger
 */
export declare function Returns(statusCode: number, options: Partial<IResponseOptions>): any;
export declare function Returns(options: Partial<IResponseOptions>): any;
export declare function Returns(model: Type<any>): any;
export declare function Returns(model: Type<any>, options: Partial<IResponseOptions>): any;
/**
 * Add responses documentation for a specific status code.
 *
 * ## Examples
 ...
 * @swagger
 */
export declare function ReturnsArray(statusCode: number, options: Partial<IResponseOptions>): any;
export declare function ReturnsArray(options: Partial<IResponseOptions>): any;
export declare function ReturnsArray(model: Type<any>): any;
export declare function ReturnsArray(model: Type<any>, options: Partial<IResponseOptions>): any;
